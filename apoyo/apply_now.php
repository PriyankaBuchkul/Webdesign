                         ...
                         <form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                        	<input required type="date" class="form-control" name="dob" placeholder="Date Of  "></div>
                                        <div class="form-group">
									...
									<div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <textarea required class="form-control" name="inquiry" placeholder="require" rows="2" cols="50"></textarea>
                                        </div>
                                        <div class="form-group">
