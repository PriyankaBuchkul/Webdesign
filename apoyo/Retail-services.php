...
<body>
    ...
    <div id="all">
        ...
        <div id="heading-breadcrumbs" style="    background: url(img/pageheaderimages/retail-banner.png) center center repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1> Retail services</h1>
                     <P class="mainhead">
Go beyond our imagination and develop exceptional website that guarantee success</p>
                    </div>
                    <div class="col-md-5">
        ...
        <div id="content">
            <div class="container">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                           ...
                                           <li><a href="vision_values.php">Vision &amp; Values</a></li>
                                               <li><a href="Infrastructure.php">Infrastructure</a></li>
                                                                                       <li><a href="partnership.html">Partnership Opportunities</a></li>
                                            <li><a href="terms_and_conditions.html ">Terms &amp; Conditions</a></li>
                                           <li><a href="careers.php">Career At Apoyo Technologies</a></li>
			  ...
			  <div class="col-md-8">
                     ...
                     <p class="hilight-text">This statement is justified by the fact that a customer is vital & crucial to any retail business just like the indispensable oxygen. As a result of which the retailers are focusing more and more on customer-centric strategies to pave way for channel expansion.</p>
                     <p>Cost effectiveness trailed by operational efficiency can be accomplished with the help of utilizing appropriate IT systems. We provide multi-dimensional solutions that cater to all type of retailer’s requirement. </p>
					 <p class="mark">The feature that provides an edge over others is that our solutions work for you at every level of your business operations. Through our advanced retail customized solutions, we help out our worldwide retailers to put up a stronger connect with their customers. </p>
					 <p>Transforming business through consulting, application development and maintenance, infrastructure and business process outsourcing is what Apoyo Technologies exhibits its expertise in. Our specialist work in alliance with you to fabricate solutions that addresses your distinctive challenges.</p>
					 
					 <h2>Retail <b>Services Include: </b></h2>
					 <ul class="point-list style-star li-md-6">
                        <li>Business-centric Ecommerce / B2C Solutions </li>
                        <li>Full-Cycle ERP / CRM solutions </li>
                        <li>Facilities Management Solutions </li>
                        <li>Point-of-Sales(POS) Systems Integration </li>
						<li>Inventory Management Solutions </li>
						<li>Legacy Migration Solutions </li>
						<li>Web 2.0 / 3.0, Mobile Technology and SaaS Enablement </li>
