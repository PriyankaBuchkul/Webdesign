...
if(isset($_POST['btn-signup'])) {
 ...
 $msg = $DBcon->real_escape_string( $msg );
  

  
  $query = "INSERT INTO message(name,email,phone,company,subject,message) VALUES('$mname','$email','$phone','$company',' $subject',' $msg')";
    ...
    _________________________________________________________ -->
        ...
        <div id="heading-breadcrumbs" style="    background: url(img/pageheaderimages/education-banner.png) center center repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h1>Contact Us  - Apoyo Technologies</h1>
  ...
  ?>
                    ...
                    <span id="check-e"></span>
                      ...
                      <input type="text" class="form-control" placeholder="phone" name="phone" required  />
                        ...
                        <div class="form-group"> 
                           <textarea class="form-control" placeholder="Comment"  name="message" id="comment"></textarea> 
                        </div>
                    
                                                <div class="form-group"> 
                           <button id="contact-submit" class="btn btn-danger btn-lg" name="btn-signup">Submit</button> 
                        </div>
                    </form>
                 </div>                
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.2928898876276!2d73.85252731445796!3d18.515661987411825!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c06fcb14dd05%3A0x82fbc036622860f4!2sApoyo+Technologies!5e0!3m2!1sen!2sin!4v1509600433736" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
                 </div>
                                    </div>     
              </div>
