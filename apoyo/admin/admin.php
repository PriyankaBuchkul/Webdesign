...
<!--/end container-->
   ...
   <div class="row">
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            	<a href="register.php" class="btn btn-primary btn-block btn-flat">Add Admin</a>
            </div>
                <div class="col-xs-4 col-sm-4 col-md-4"></div>
        </div>
  <br><br><br><br>      
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">Current Admin</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    include_once 'connect.php';
                    $c=1;
        $query = mysqli_query($DBcon,"SELECT* FROM `users` ORDER BY id DESC")or die(mysqli_error($DBcon));
  ...
  ?>        
                ...
                <td><?php echo $c++ ?></td>
                  ...
                  <td><?php echo $row['password'] ?></td>
					  ...
					  <td>&nbsp;&nbsp;<a href="edit_admin.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true">
<!--                          var_dump($row['lname']);die;-->
                          </span></a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_admin.php?id=<?php echo $id; ?>" onclick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
<?php
 }
