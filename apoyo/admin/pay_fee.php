...
if(isset($_POST['register']))
{
            ...
            $ftp=$_POST['ftp'];
                $rfee=$k-$ftp;
                 $re="UPDATE `tstudent` SET `rfee`='".$rfee."' WHERE `id`='$id'";
                    $re2="INSERT INTO `feedate`(`id`,`date`,`fee`) VALUES ('".$id."',NOW(),'".$ftp."')";
                  $re3 = mysql_query($re2) or die ("Could not Save in table! ");
                  $result = mysql_query($re)
                    ...
                    if($result)
                    {
                      echo '<script type="text/javascript">'; 
                          ...
                          echo 'window.location.href = "fees.php";';
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i>Home</a></li>
          <li><a href="fees.php">Candidate Training Fee</a></li>
	...
	<div class="row">
		...
		<div class="col-xs-6">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Pay Fee</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<input required type="text" disabled class="form-control" name="name" value="<?php echo $row['name'] ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input  type="text" disabled class="form-control" name="mobno" name="name" value="<?php echo $row['mobno'] ?>">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                     <div class="col-md-3"></div>
								</div><br />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
										<input  type="text" disabled class="form-control" name="course" value="<?php echo $row['course'] ?>">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                      <div class="col-md-3"></div>
								</div><br />
                                  <div class="row">
                                      <div class="col-md-3"><label>Total Fee</label></div>
                                    <div class="col-md-6">
										<input type="text" disabled class="form-control" name="tfee" value="<?php echo $row['tfee'] ?>">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                      <div class="col-md-3"></div>
								</div><br />
                                  <div class="row">
                                      <div class="col-md-3"><label>Due Fee</label></div>
                                    <div class="col-md-6">
										<input type="text" disabled class="form-control" name="course" value="<?php echo $row['rfee'] ?>">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                      <div class="col-md-3"></div>
								</div><br />
                                  <div class="row">
                                      <div class="col-md-3"><label>FEE TO PAY</label></div>
                                    <div class="col-md-6">
										<input required type="text"  class="form-control" name="ftp">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                      <div class="col-md-3"></div>
								</div><br />
