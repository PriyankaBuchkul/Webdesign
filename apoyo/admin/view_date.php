    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i>Home</a></li>
          ...
          <li class="active"><a href="#">Fee Date</a></li>
      </ol>
    </section>
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">Fee Date</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    ...
                    $c=1;
                    $id=$_GET['id'];
        $query = mysqli_query($DBcon,"SELECT* FROM `feedate` where id=$id ")or die(mysqli_error($DBcon));
