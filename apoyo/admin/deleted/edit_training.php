...
if(isset($_POST['register']))
{
	       $name=$_POST['name'];
            ...
            {    
                $k=$row['image'];
                $k1="../img/trainingstud/$k";
                     unlink($k1);
                   $re="UPDATE `tstudent` SET `name`='".$name."',`dob`='".$dob."',`email`='".$email."',`mobno`='".$mobno."',`address`='".$address."',`doj`='".$doj."',`course`='".$course."',`tfee`='".$tfee."', `image`='".$file."' WHERE `id`='$id'";
           ...
           {   
                $re="UPDATE `tstudent` SET `name`='".$name."',`dob`='".$dob."',`email`='".$email."',`mobno`='".$mobno."',`address`='".$address."',`doj`='".$doj."',`course`='".$course."',`tfee`='".$tfee."' WHERE `id`='$id'";
                  $result = mysql_query($re)
                    or die ("Could not Update!");
                    if($result)
                    {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Update Training Candidate</a></li>
      </ol>
    </section>
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Update Training Candidate</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-4">
                                        <label>Course</label>
										<input required type="text" class="form-control" name="course" value="<?php echo $row['course'] ?>">
										
									</div>
                                    <div class="col-md-4">
                                        <label>Total fee</label>
										<input required type="text" class="form-control" name="tfee" value="<?php echo $row['tfee'] ?>">
