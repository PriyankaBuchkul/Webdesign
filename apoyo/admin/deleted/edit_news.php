...
?>
 <?php
                   include_once 'connect.php';  
                    $id=$_GET['id'];
						$query = mysqli_query($DBcon,"select * from news where id = '$id'")or die(mysqli_error($DBcon));
...
if(isset($_POST['register']))
{
            ...
            $re="UPDATE `news` SET `title`='".$title."',`descr`='".$descr."' WHERE `id`='$id'";
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Update News</h2></div>
