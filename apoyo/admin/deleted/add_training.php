...
if(isset($_POST['register']))
{
                ...
                if(move_uploaded_file($file_loc,$folder.$final_file) )
                {
                        ...
                        $re="INSERT INTO `tstudent`(`name`,`dob`,`email`,`mobno`,`address`,`doj`,`course`,`tfee`,`rfee`, `image`) VALUES ('".$name."','".$dob."','".$email."','".$mobno."','".$address."','".$doj."','".$course."','".$tfee."','".$tfee."','".$file."')";
                       echo 'kkk';
                        ...
                        if($res_ins_query)
                        {
                           ...
                           echo '<script type="text/javascript">'; 
                            ...
                            echo 'window.location.href = "add_training.php";';
                            echo '</script>';
                       }
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../images/logo/a logo 3.png" at.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Admin&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../images/logo/at logo.png" logo 3.png" class="img-circle" alt="User Image">
                <p>
                  Admin
                </p>
              </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../images/logo/a logo 3.png" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p style="margin-left:5px;">Apoyo Technologies</p>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i>Home</a></li>
          <li><a href="training.php">Training Candidate</a></li>
		<li class="active"><a href="#">Add Training Candidate</a></li>
      </ol>
    </section>
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Add Candidate</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-4">
                                        <input required type="text" class="form-control" name="mobno" placeholder="Enter Mobile No">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
								</div><br />
								<div class="row">
									...
									<div class="col-md-4">
                                        <textarea required class="form-control" name="address" placeholder="Enter Address" rows="4" cols="50"></textarea>
                                   ...
                                   <div class="col-md-4">
										...
										<input required type="date" class="form-control" name="doj" placeholder="Date Of Joining ">
								...
								<div class="row">
									<div class="col-md-4">
										<input required type="text" class="form-control" name="course" placeholder="Enter Course">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                    <div class="col-md-4">
										<input required type="text" class="form-control" name="tfee" placeholder="Enter Total Fee">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                    <div class="col-md-4">
                                      
										<input required type="file" class="form-control" name="image" placeholder="Insert Photo">
