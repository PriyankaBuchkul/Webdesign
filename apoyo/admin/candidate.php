...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">All Candidate</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    include_once 'connect.php';
                    $c=1;
        $query = mysqli_query($DBcon,"SELECT* FROM `apply` ORDER BY id DESC")or die(mysqli_error($DBcon));
  ...
  ?>        
                ...
                <td><?php echo $row['dob'] ?></td>
                 ...
                 <td><a href="resume/<?php echo $row['file'] ?>" target="_blank" style="color:black;">View Resume</a></td>
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_student.php?id=<?php echo $id; ?>" onClick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
                <?php
                 }
