      ...
      <ul class="sidebar-menu">
		...
		<li >
          ...
          <a href="admin.php">
           ...
           <li>
          <a href="testimonial.php " class="active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            	<a href="add_testimonial.php" class="btn btn-primary btn-block btn-flat">Add Testimonial</a>
            </div>
                <div class="col-xs-4 col-sm-4 col-md-4"></div>
        </div>
  <br><br><br><br>
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">Testimonial</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    include_once 'connect.php';
                    $c=1;
        $query = mysqli_query($DBcon,"SELECT* FROM `testimonial` ORDER BY id DESC")or die(mysql_error());
  ...
  ?>        
                ...
                <td><?php echo $row['descr'] ?></td>
					  ...
					  <td>&nbsp;&nbsp;<a href="edit_testi.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_testi.php?id=<?php echo $id; ?>" onClick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
<?php
 }
