  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Messsage</a></li>
      </ol>
    </section>
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">All Messages from Contact Page</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    include_once 'connect.php';
                    $c=1;
        $query = mysqli_query($DBcon,"SELECT* FROM `message` ORDER BY id DESC")or die(mysqli_error($DBcon));
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_comment.php?id=<?php echo $id; ?>" onClick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
<?php
 }
