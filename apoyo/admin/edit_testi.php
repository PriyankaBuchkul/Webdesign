...
?>
 <?php
                   include_once 'connect.php';  
                    $id=$_GET['id'];
						$query = mysqli_query($DBcon,"select * from testimonial where id = '$id'")or die(mysqli_error($DBcon));
...
if(isset($_POST['register']))
{
            ...
            $re="UPDATE `testimonial` SET `title`='".$title."',`descr`='".$descr."' WHERE `id`='$id'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Update testimonial</a></li>
      </ol>
    </section>
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Update testimonial</h2></div>
