  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            	<a href="add_jobs.php" class="btn btn-primary btn-block btn-flat">Add New jobs</a>
            </div>
                <div class="col-xs-4 col-sm-4 col-md-4"></div>
        </div>
  <br><br><br><br>
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">Jobs</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
...
<?php
                    include_once 'connect.php';
                    $c=1;
        $query = mysqli_query($DBcon,"SELECT* FROM `jobs` ORDER BY id DESC")or die(mysqli_error($DBcon));
  ...
  ?>        
				<tr>
                  ...
                  <td><?php echo $row['req1'] ?></td>
            
                 
               
                   
					  <td>&nbsp;&nbsp;<a href="edit_jobs.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_jobs.php?id=<?php echo $id; ?>" onClick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
<?php
 }
