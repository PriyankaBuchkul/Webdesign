...
if(isset($_POST['register']))
{
            ...
            $req1=$_POST['req1'];
                    ...
                    $re="INSERT INTO `jobs`(`tab`,`title`,`subtitle`,`req1`) VALUES ('".$tab."','".$title."','".$subtitle."','".$req1."')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Add Jobs</a></li>
      </ol>
    </section>
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Add Jobs</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input required type="text" class="form-control" name="tab" placeholder="Enter Job Title">
                                    ...
                                    <div class="col-md-8">
                                        <input required type="text" class="form-control" name="title" placeholder="Enter Sub title">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    ...
                                    <div class="col-md-8">
                                         <textarea required class="form-control" name="req1" placeholder="Enter Description " rows="4" cols="50"></textarea>
								...
								<div class="row">
									...
									<div class="col-md-8">
                                        ...
                                        <input required type="text" class="form-control" name="subtitle" placeholder="Enter Requirement">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
...
<!--end datatable of all subjets-->
  ...
  <!-- /.main content-wrapper -->
    ...
    <div class="row">
			...
			<div class="col-md-4 col-xs-4">
				 <center><p >Crafted by <a href="#"><b>Wab IT Solution</b></a> </p></center>
			</div>
			<div class="col-md-4 col-xs-4">
