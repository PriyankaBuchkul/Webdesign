	...
	<div class="row">
		...
		<div class="col-xs-8">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Manage Account</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<a href="change_username.php" class="btn btn-primary btn-block btn-flat">Change UserName</a>
									</div>
									...
									<!-- /.col -->
									<div class="col-xs-4">
                                        <a href="change_password.php" class="btn btn-primary btn-block btn-flat">Change Password</a>
  ...
  <!-- /.main content-wrapper -->
    ...
    <div class="row">
			<div class="col-md-4 col-xs-4">
				 <center>   <p > <a href="index.php"><b>/b></a></p></center>
			</div>
			<div class="col-md-4 col-xs-4">
