...
if(isset($_POST['register']))
{
                ...
                $descr=$_POST['descr'];
                        ...
                        $re="INSERT INTO `testimonial`(`title`,`descr`) VALUES ('".$title."','".$descr."')";
                        ...
                        if($res_ins_query)
                        {
                           ...
                           echo '<script type="text/javascript">'; 
                            ...
                            echo 'window.location.href = "add_testimonial.php";';
                            echo '</script>';
                       }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active" style="background-color:rgba(0, 124, 195, 1)"><a href="#">Add Testimonial</a></li>
      </ol>
    </section>
