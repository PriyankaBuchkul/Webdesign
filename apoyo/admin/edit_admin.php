...
?>
 <?php
                   include_once 'connect.php';  
                    $id=$_GET['id'];
						$query = mysqli_query($DBcon,"select * from users where id = '$id'")or die(mysqli_error($DBcon));
...
{ 
   ...
   $re="UPDATE `users` SET `name`='".$name."',`email`='".$email."',`password`='".$password."' WHERE `id`='$id'";
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Update Admin</h2></div>
