  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Training Candidate</a></li>
      </ol>
    </section>
    ...
    <section class="content">
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            	<a href="add_training.php" class="btn btn-primary btn-block btn-flat">Add Training Candidate</a>
            </div>
                <div class="col-xs-4 col-sm-4 col-md-4"></div>
        </div>
  <br><br><br><br>
...
<!--datatable of all subject-->
		...
		<div class="col-xs-4 col-sm-4 col-md-4">
            <div class="box-header">
              <h3 class="box-title" style="font-size:21px;">Training Candidate</h3>
            </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4"></div>
                </div>
                ...
                <td><?php echo $row['dob'] ?></td>
                 ...
                 <td><?php echo $row['address'] ?></td>
                  <td><?php echo $row['doj'] ?></td>
                   <td>  <a href="../img/trainingstud/<?php echo $row['image']  ?>" class="prettyphoto">
                               <center> <img src="../images/training/<?php echo $row['image']  ?>" alt="" /></center> </th>
                  ...
                  <td><?php echo $row['tfee'] ?></td>
                    <td><?php echo $row['rfee'] ?></td>
					  ...
					  <td>&nbsp;&nbsp;<a href="edit_training.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    function ConfirmDelete()
    {
      ...
      if (x)
        ...
        return false;
					  ...
					  <a href="delete_training.php?id=<?php echo $id; ?>" onClick="return ConfirmDelete();"><span class="glyphicon glyphicon-trash" aria-hidden="true" style="color:red;"></span></a>
					  </td>
                </tr>
<?php
 }
