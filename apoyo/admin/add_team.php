...
if(isset($_POST['register']))
{
                    ...
                    if(move_uploaded_file($file_loc,$folder.$final_file) )
                    {
                            ...
                            $re="INSERT INTO `team`(`name`,`dob`,`email`,`mobno`,`address`,`doj`,`desi`,`salary`,`descr`, `image`) VALUES ('".$name."','".$dob."','".$email."','".$mobno."','".$address."','".$doj."','".$desi."','".$salary."','".$descr."','".$file."')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><a href="#">Add Team Member</a></li>
      </ol>
    </section>
	...
	<div class="row">
		...
		<div class="col-xs-11">
				<div class="panel panel-primary" style="margin-top:50px;">
					<div class="panel-heading" style="text-align:center;"><h2>Add Team Member</h2></div>
					...
					<div class="panel-body">
						<form name="form" action="" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-4">
										<input required type="text" class="form-control" name="desi" placeholder="Enter Designation">
										<span class="glyphicon glyphicon-user form-control-feedback"></span><br>
                                        <input required type="text" class="form-control" name="salary" placeholder="Enter Salary">
										<span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                    
                                    <div class="col-md-4">
										 <textarea required class="form-control" name="descr" placeholder="Enter Qualification" rows="4" cols="50"></textarea>
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
									</div>
                                    <div class="col-md-4">
