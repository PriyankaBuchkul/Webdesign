                ...
                <section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel-group accordion" id="accordionThree">
                               ...
                               <li><a href="vision_values.php">Vision &amp; Values</a></li>
                                ...
                                <li><a href="our-team.html">Apoyo Technologies Team</a></li>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="heading">
                                <h2>Developmeny Company - Apoyo Technologies</h2>
                            </div>

                                 <p class="hilight-text">Apoyo Technologies is an ISO 9001:2008 certified company with its registered offices in India, USA and UK. The company has its enterprise level and utility based solutions in a wide array of technology as iPhone, android, PHP, .Net, open source etc.  We have a skilled pool of technical professionals that have expertise in the latest Web & Mobile technologies, offering high level IT solutions to our global business clients. </p>
                     <p>Over the years, we have developed a huge list of websites as education, healthcare, media & entertainment, hospitality, manufacturing, lifestyle industry, telecom and other services. Apoyo Technologies as a Web & Mobile Application Development firm, and has since created hundreds of apps serving a wide range of interestes and industries.</p>
                        </div>
                    </div>
