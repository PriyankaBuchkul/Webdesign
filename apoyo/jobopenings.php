...
<body>
    ...
    <div id="all">
        ...
        <div id="heading-breadcrumbs" style="    background: url(img/pageheaderimages/open-source-technologies-banner.png) center center repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                ...
                <section>
                    ...
                    <div class="row">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                        <ul class="point-list style-hand">
                                <li><a href="profile.html">Our Profile</a></li>
                                <li><a href="our-team.html"> Apoyo Technologies's Team</a></li>
                                <li><a href="quality-commitment.html">Quality Commitment</a></li>
                                <li><a href="our-development-methodology.html">Our Development Methodology</a></li>
                                <li><a href="project-communication-strategy.html">Project Communication Strategy </a></li>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="heading" data-animate="fadeInUp">
                                <h2>Openings</h2>
                            </div>

                                 <p class="hilight-text">We are hiring new staff on a regular basis to fill in the positions that completes our team in most authentic manner. Explore currently available positions and find out how you could become an integral part of the established software team of  Apoyo Technologies Private Limited.</p>
    <br />
    
     
                                  <?php
	                   $sql="SELECT * FROM jobs order by id DESC";
	                   $result_set=mysqli_query($DBcon,$sql);
                    ...
                    <div class="borders" data-animate="fadeInLeft">
                     <div class="row">
                                <div class="col-md-5" >
                                  <h2><?php echo $row['tab']  ?></h2>
                                    <?php $k='tab'.$c;  ?>
                     
                      <p>Qualifications: <?php echo $row['title']  ?></p>
                       <p>Experience: <?php echo $row['subtitle']  ?></p>
                     <a class="btn apnow" href="apply_now.php">Apply Now</a>
