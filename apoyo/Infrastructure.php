...
<?php require("menu.php") ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <P class="mainhead">Apoyo Technologies have infrastructure required to deliver and work efficiently.</p>
                    </div>
                    <div class="col-md-5">
        ...
        <div id="content">
			...
			<div class="row iphone-development1">
			  ...
			  <div >
					 <h2>Company  <b> Infrastructure</b></h2>
					 <P class="hilight-text">The  most important thing for any company to perform is infrastructure. At Apoyo Technologies we understand the value of having a well built infrastructure for providing high quality solutions to clients. To give best quality products at the end of the project, we have fortified infrastructure required to deliver and work efficiently. At Apoyo Technologies you will surely get excellent working environment. </P>
                     <p>Here are some of the highlights for infrastructural facilities at Apoyo Technologies. </p>
                     
					 <P  class="hilight-text">Our infrastructure Facilities build for you:</P>
					 <ul class="point-list style-jet li-md-6">
                        <li>24*7 power availability and CCTV surveillance for better security</li>
                        <li>High end Malware and virus protection for all systems</li>
                        <li>Centrally air-conditioned with all modern amenities</li>
                        <li>latest devices for project implementation</li>
						<li>state of the art network security</li>
						<li>high configuration computer systems</li>
						<li>tablets and smartphone for testing</li>
						<li>Scalable network architecture and systems</li>
						<li>regular data backup</li>
						<li>Gold standard fire protection</li>
						<li>VoiP facility for effective client communication</li>
						<li>real time anti virus protection</li>
						<li>high end servers</li>
						<li>internet redundancy</li>
						<li>communication redundancy</li>
						<li>highly stable project management system to monitor and administer the total work flow and service delivery.</li>
