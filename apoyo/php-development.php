...
<body>
    ...
    <div id="all">
        ...
        <div id="heading-breadcrumbs" style="    background: url(img/pageheaderimages/ecommerce-development-banner.png) center center repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                       <h1>PHP-MySQL </h1>
        ...
        <div id="content">
            <div class="container">
              ...
              <div class="col-md-12 pagenations">
                ...
                <div class="col-md-4 contact-form padding-none">
               
             <div class="request-for-quote rfq-style-green clearfix">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                          <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Custom Software Development </a>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                          <div class="panel-body">
                            <ul class="point-list style-hand">
                                <li><a href="software-product-development.html">Product Development</a></li>
                                <li><a href="saas-development.html">SaaS Development</a></li>
                                <li><a href="crm-development.html">CRM Development</a></li>
                                <li><a href="business-intelligence-application-development.html">BI App Development</a></li>
                                <li><a href="database-management-solutions.html">Database Management Solutions</a></li>
                                <li><a href="software-consulting.html">Software Consulting</a></li>
							   <li><a href="integration-solutions.html">Integration Solutions</a></li>
							   <li><a href="big-data-solutions.html">Big Data Solutions</a></li>	
                            </ul>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Mobile Application Development</a>
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body">
                             <ul class="point-list style-hand">
                                <li><a href="android-application-development.html">Android Application Development</a></li>
                                <li><a href="iphone-application-development.html">iPhone Application Development</a></li>
                                <li><a href="ipad-application-development.html">iPad Application Development</a></li>
                                <li><a href="windows-mobile-app-development.html">Windows Mobile App Development</a></li>
                                <li><a href="hybrid-mobile-app-development.html">Hybrid Mobile App Development </a></li>
                                <li><a href="enterprise-mobility-solutions.html">Enterprise Mobility Solutions</a></li>
								<li><a href="iphone-games-development.html">iPhone Games Development</a></li>
								<li><a href="ipad-games-development.html">iPad Games Development</a></li>
								<li><a href="ipad-social-app-development.html">iPad Social App Development</a></li>
								<li><a href="android-games-development.html">Android Games Development</a></li>
					    ...
					    <div class="panel panel-default">
                         <div class="panel-heading" role="tab" id="headingThree">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Web Design & Development</a>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body">
                             <ul class="point-list style-hand">
                                ...
                                <li><a href="amazon-webstore-development.html">Amazon Webstore Development</a></li>
                                <li><a href="custom-ecommerce-development.html">Custom eCommerce Development</a></li>
                                <li><a href="drupal-ubercart-development.php">Drupal UberCart Development</a></li>
                                <li><a href="opencart-development.html">OpenCart Development</a></li>
                                <li><a href="zen-cart-development.html">ZenCart Development</a></li>
                                <li><a href="shopify-development.html"> Shopify Development</a></li>
								<li><a href="magento-extension-development.html"> Magento Extension Development</a></li>
								<li><a href="know-more-about-magento.html"> Know More About Magento</a></li>
								<li><a href="redesign-magento-store.html"> Redesign Magento Store</a></li>
					 ...
					 <div class="panel panel-default">
					  ...
					  <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingFive">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Portal Development</a>
                        </div>
					  ...
					  <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingSix">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">Digital Marketing</a>
                        </div>
					 ...
					 <div class="panel panel-default">
                        ...
                        <div class="panel-heading" role="tab" id="headingSeven">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">Support</a>
                        </div>
			  ...
			  <div class="col-md-8">
					 <h2>PHP-MySQL  <b> Technologies </b></h2>
                     <p class="hilight-text">PHP has been widely used for developing the website designs. PHP has been used over 250+ million websites and around millions of web server worldwide. We have worked with various clients to execute their extreme project on PHP Platform and served both domestic as well international clients.</p>
                     <p>For any business to be successful one need to make a website for marketing its service to its extreme target market everywhere. But in terms of website development PHP has made its stand is a widely-used open source general-purpose scripting language and risen its popularity in terms of website development our past decade and  this has led to increase in demand for skilled PHP developer.</p>
					 
					 <h2>Apoyo Technologies‘s <b>PHP Development Services:</b></h2>
					 <p>There are several key points to adopt our php team for successful implementation of your website. PHP is dynamic  in nature and embedded with large number of libraries which provides user with more functionality and versatility. So, In case if you are planning to start business ,then definitely Php is the way to go for your new user friendly website development. </p>
					 
					 <h2>PHP <b>Development Technologies </b></h2>
					 <h2>CakePHP</h2>
					 <p>CakePHP is an user friendly website development application framework which was introduced in year 2005 and has since then grown in its number of users and is favored by large number of developer and business owner for its CMS development services. </p>
					 <h2>Codeigniter</h2>
					 <p>Codeigniter was developed to reduce the complexity with php programming and provide clients with simple and elegant cost effective solutions. Codeigniter is php based web application framework that allows developers in creating broadly superior solutions with greater performance and effective cost. </p>
					<h2>Symfony 2</h2>
					<p>Symfony2 is an enterprise grade PHP development framework. Security audited, sophisticated object oriented architecture, latest techniques and large community support makes it an ideal development platform for enterprise applications. </p>
					<h2>Zend 2</h2>
					<p>Zend Framework is a most popular open source PHP Framework for advanced high performing PHP applications. It is considered to be the foremost PHP frameworks in terms of web application development. It is idle for both developers and clients as it is open source framework that enables developers to design versatile web application with prominent rich and extensible features.</p>
					<h2>Yii</h2>
					<p>Yii or say Yes is an free, open source community, object-oriented, component based on MVC PHP web application framework best for developing Web applications that promotes clean and highly scalable design and encourages rapid development. It works to rationalize application development and helps to ensure a remarkably productive, extensible, and manageable end product.</p>
					
					<div class="clearfix"></div>
					
					<p class="hilight-text">Dominant PHP Development Company: Apoyo Technologies</p>
					
					<p>Apoyo Technologies has been offering its PHP  services across the globe with  more than 5+years of experienceWe at Apoyo Technologies employ highly expertise and knowledgeable workforce on various technologies and platforms.</p>
					<p>If you are looking for web development company for your business website development then, Apoyo Technologies is a best choice for all types clients spread worldwide. Php web based website are highly reliable, user friendly, scalable with  different  creating, merging  approach to improve your workflow. It provides with various tools, resources, knowledge, skills to address any complex web site development issues for its vast bundle of customer across.</p>
